...
\begin{defn}[Energia libera di Halmotz]{defn:Energia libera di Halmotz}
\[
	F = E - TS
.\]
\end{defn}
...
\begin{defn}[Energia libera di Gibbs]{defn:Energia libera di Gibbs}
\[
	\phi = F + PV
.\] 
\end{defn}
...
\begin{fact}[Differenziale del potenziale chimico]{fact:Differenziale del potenziale chimico}
\[
...
\begin{defn}[Potenziale di Landau]{defn:Potenziale di Landau}
\[
	\Omega = F - \mu N
.\] 
\end{defn}
...
\subsection{Principio variazionale e $\Omega < 0$}%
