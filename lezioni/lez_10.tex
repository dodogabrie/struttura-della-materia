...
\begin{fact}[Effetto termoionico in presenza di un campo elettrico $F$ costante]{fact:Effetto termoionico in presenza di un campo elettrico F costante}
\[
	J_{F}= J_0\cdot \exp\left( e^{3 /2}F^{1 /2} /kT \right) 
.\] 
\end{fact}
L'effetto del campo elettrico diventa rilevante quando $e^{3 /2}F^{1 /2} \sim kT$.\\
