...
\[
    ...
    \tilde{a}_1(t) = 0
.\] 
\subsubsection{Detuning in risonanza}%
...
\begin{defn}[Frequenza di Rabi]{defn:Frequenza di Rabi}
\[
  \Omega_r = \frac{E_0 \hat{e}\cdot \v{d}_{12}}{\hbar }  
.\] 
\end{defn}

Le soluzioni con le nostre condizioni saranno:
\[
...
\begin{fact}[Periodo oscillazioni di Rabi]{fact:Periodo oscillazioni di Rabi}
\[
...
\begin{fact}[Equazioni di Rate: niente interferenze]{fact:Equazioni di Rate: niente interferenze}
Descrivendo il sistema con le equazioni di Rate perdiamo le informazioni sulle coerenze del sistema.
\end{fact}
Questi fenomeni venivano invece descritti con le oscillazioni di Rabi e la RWA.\\
...
\subsubsection{Necessità di Emissione spontanea}%
...
\begin{defn}[Coefficiente di emissione spontanea]{defn:Coefficiente di emissione spontanea}
\[
A_{1\to 2}=\frac{4}{3\hbar }\frac{\omega_{12}^3}{c ^3}\left|\bra{1}d\ket{2}\right|^2
.\] 
\end{defn}
Questo coefficiente si ottiene anche quantizzando il campo elettromagnetico.
...
\subsubsection{Trattazione quantistica del coefficiente di emissione spontanea}%
...
\begin{fact}[Caso quantistico per l'interazione]{fact:Caso quantistico per l'interazione}
...
\subsection{Variazione della intensità della radiazione in un mezzo materiale}%
...
\begin{defn}[Coefficiente di assorbimento]{defn:Coefficiente di assorbimento}
...
\begin{fact}[Inversione di popolazione]{fact:Inversione di popolazione}
