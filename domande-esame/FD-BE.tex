...
\end{quest}
\begin{quest}[Risposta di un gas di elettroni liberi ad un campo magnetico]{quest:Risposta di un gas di elettroni liberi ad un campo magnetico}
...
\end{quest}
\begin{quest}[Che succede se tolgo il termine cinetico alla $H$ della dom. precedente?]{quest:Che succede se tolgo il termine cinetico alla $H$ della dom. precedente?}
...
\end{quest}
\begin{quest}[Perchè abbiamo potuto trattare il sistema della dem. adiabatica in modo classico?]{quest: in modo classico?}
...
\end{quest}
\begin{quest}[Perché non si usa la funzione di part. $Z^{N}_1$ nel caso MQ?]{quest:Perché non si usa la funzione di caso MQ?}
